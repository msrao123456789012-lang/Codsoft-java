...
public class Task1
{
   ...
   //initializing score to zero
    ...
    int score1=m.playgame(sc,r,score);
	    //printing total score obtained by user
    System.out.println("your score is:"+score1);
	}
	public int playgame(Scanner sc,Random r,int score){
    ...
    while(true){
      ...
      if(choicelimit>=1){
	     System.out.println("enter your guess the number from ranges from 1-100:");
